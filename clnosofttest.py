...
encoder.load_state_dict(torch.load('./checkpoints/a2w/no_soft_encoder6000.pth'))
classifier.load_state_dict(torch.load('./checkpoints/a2w/no_soft_class_classifier6000.pth'))
